...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("up", ["select 1 ", "from a "], Cursor(0, 8), Cursor(0, 0, pref_pos=8)),
        ("down", ["select 1 ", "from a "], Cursor(0, 8), Cursor(1, 6, pref_pos=8)),
        (
            "down",
            ["select 1 ", "from a ", "123456789"],
            Cursor(1, 6, pref_pos=8),
            Cursor(2, 8),
        ),
        ("up", ["select 1 ", "from a "], Cursor(1, 6, pref_pos=8), Cursor(0, 8)),
